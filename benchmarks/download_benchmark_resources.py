...
class Args(argparse.Namespace):
    ...
    def __parse(self):
        ...
        p = argparse.ArgumentParser(
            prog="download_benchmark_resources",
            description=(
        ...
        p.add_argument(
            "--top-hash",
            # Generated package hash from upload_benchmark_resources
            default=None,
            help=(
...
def download_benchmark_resources(args: Args):
