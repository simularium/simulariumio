...
@pytest.mark.parametrize(
    "trajectory, _filter, expected_data, expected_data_filtered",
    [
        (
...
def test_add_agents_filter(trajectory, _filter, expected_data, expected_data_filtered):
    ...
    buffer_data_filtered = converter._read_trajectory_data(filtered_data)
    assert expected_data == buffer_data
    assert expected_data_filtered == buffer_data_filtered
