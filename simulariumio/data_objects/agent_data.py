...
class AgentData:
    ...
    @staticmethod
    def get_display_info(type_mapping: Dict[str, Any]) -> Dict[str, DisplayData]:
        """
        Generate the display_info mapping from a type_mapping
        """
        result = {}
    ...
    def from_buffer_data(cls, buffer_data: Dict[str, Any]):
        ...
        display_info = AgentData.get_display_info(
    ...
    def get_copy_with_increased_buffer_size(
        ...
        result.display_info = copy.deepcopy(self.display_info)
    ...
    def __deepcopy__(self, memo):
        result = type(self)(
            ...
            display_info=copy.deepcopy(self.display_info, memo),
    ...
    def __eq__(self, other):
        return (
            ...
            and self.display_info == other.display_info
